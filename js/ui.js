...
tabPages: [
  ...
  annualSnackPrintPreview: el("annualSnackPrintPreview"),
  ...
  checklistPrintDailyBtn: el("checklistPrintDailyBtn"),
  checklistPrintMonthlyBtn: el("checklistPrintMonthlyBtn"),
  checklistPrintStatus: el("checklistPrintStatus"),
  checklistPrintDailyPreview: el("checklistPrintDailyPreview"),
  checklistPrintMonthlyPreview: el("checklistPrintMonthlyPreview"),
